      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          ...
          <motion.button
            ...
            className="w-full py-2 px-4 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
          >
